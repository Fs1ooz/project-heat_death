...
const ASTEROID_SCENE_PATH: String = "res://Entities/Enemies/SmallBodies/Asteroids/asteroid.tscn"
const METEOROID_SCENE_PATH: String = "res://Entities/Enemies/SmallBodies/Meteoroids/meteoroid.tscn"
